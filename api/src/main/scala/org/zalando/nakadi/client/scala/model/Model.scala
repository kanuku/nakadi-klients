...
/**
  ...
  */
case class DataChangeEvent[T](data: T,
                              dataType: String,
                              @JsonProperty("data_op") @JsonScalaEnumeration(
                                  classOf[DataOperationType]) dataOperation: DataOperation.Value,
...
/**
  ...
  */
case class Partition(partition: String,
...
case class EventType(
    ...
    @JsonScalaEnumeration(classOf[PartitionStrategyType]) partitionStrategy: Option[
        PartitionStrategy.Value],
    schema: EventTypeSchema,
    dataKeyFields: Seq[String],
    partitionKeyFields: Seq[String],
    @JsonProperty("default_statistics") statistics: Option[
        EventTypeStatistics])
...
/**
  ...
  */
case class EventTypeSchema(@JsonProperty("type") @JsonScalaEnumeration(
                               classOf[SchemaTypeType]) schemaType: SchemaType.Value,
                           schema: String)
...
case class BatchItemResponse(
    ...
    @JsonScalaEnumeration(classOf[BatchItemStepType]) step: Option[
        BatchItemStep.Value],
    detail: Option[String])
...
class BatchItemPublishingStatusType
    extends TypeReference[BatchItemPublishingStatus.type]
